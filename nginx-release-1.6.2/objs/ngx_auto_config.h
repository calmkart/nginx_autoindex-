#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-pcre --with-http_stub_status_module --with-http_ssl_module --with-http_gzip_static_module --add-module=../file-md5-master --add-module=../ngx-fancyindex"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.8.4 (Debian 4.8.4-1) "
#endif
